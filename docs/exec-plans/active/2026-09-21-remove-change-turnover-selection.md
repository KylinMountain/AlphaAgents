...
> **2026-09-26 补记**：本计划删掉了基因，但把双榜内联留作 A 臂对照，且没有改
> `walk_forward` 默认值（§ 第 64 行那条未落地）。结果 09-25～09-26 的 Trader Runtime
> 回放全部跑在对照臂上。对照臂与默认值已由
> `2026-09-26-sector-first-only.md` 删除。
