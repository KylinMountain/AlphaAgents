...
from rl_trading_env_v4 import SingleStockTradingEnvV3, SEQ_LEN, N_CHANNELS, STATE_DIM
...
def main():
    ...
    p.add_argument('--out-model', default='/Users/evilkylin/Projects/AlphaAgents/data/rl_trading_agent_v4.zip')
    args = p.parse_args()
    ...
    model = PPO('MultiInputPolicy', env, learning_rate=3e-4, n_steps=2048,
                ...
                clip_range=0.2, ent_coef=0.02, verbose=1,  # 0.05→0.02 减少 v3 的 INVALID 噪声
